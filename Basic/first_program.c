...
// #include<stdio.h> is a preprocessor directive that tells the compiler to include the contents of stdio.h file in the program.
// #include is a preprocessor directive that tells the compiler to include the contents of the file stdio.h in the program.
